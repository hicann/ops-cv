...
unsetenv() {
  logandprint "[INFO]: Unset the environment path [ export ASCEND_OPS_CV_PATH=${relative_path_val}/${OPP_PLATFORM_DIR}]."
...
remote_all_soft_link() {
  ...
  local ops_cv_lib_files="opapi_cv opgraph_cv ophost_cv common_cv"
  for lib_name in ${ops_cv_lib_files}; do
