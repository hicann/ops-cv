...
execute_process(
    COMMAND python3 ${CPACK_CMAKE_SOURCE_DIR}/scripts/package/package.py --pkg_name ops_cv --chip_name ${CPACK_SOC} --os_arch linux-${CPACK_ARCH}
...
set(CV_VERSION_OUT_PUT
    ${CPACK_CMAKE_BINARY_DIR}/ops_cv_version.h
)

configure_file(
    ${SCENE_OUT_PUT}
    ${STAGING_DIR}/share/info/ops_cv/
    COPYONLY
)
configure_file(
    ${CSV_OUTPUT}
    ${STAGING_DIR}/share/info/ops_cv/script/
    COPYONLY
)
configure_file(
    ${CV_VERSION_OUT_PUT}
    ${STAGING_DIR}/${CMAKE_SYSTEM_PROCESSOR}-linux/include/version/ops_cv_version.h
    COPYONLY
)
...
if(EXISTS "${STAGING_DIR}/${CMAKE_SYSTEM_PROCESSOR}-linux/include/version/ops_cv_version.h")
    execute_process(COMMAND chmod 440 "${STAGING_DIR}/${CMAKE_SYSTEM_PROCESSOR}-linux/include/version/ops_cv_version.h")
endif()
...
execute_process(COMMAND bash ${MAKESELF_EXE}
        ...
        --help-header share/info/ops_cv/script/help.info
        ${makeself_param_string} share/info/ops_cv/script/install.sh
