...
if(dlog_FOUND)
  ...
  message(STATUS "Cv Variables in dlog module:")
  cmake_print_variables(dlog_CV_INCLUDE_DIR)
  ...
  set(CV_INTERFACE_INCLUDE "${dlog_CV_INCLUDE_DIR}")
  string(FIND "${dlog_CV_INCLUDE_DIR}" "toolchain" IDX)
  if(NOT IDX EQUAL -1)
    set(CV_INTERFACE_INCLUDE "${CV_INTERFACE_INCLUDE};${dlog_CV_INCLUDE_DIR}/..")
  endif()
  add_library(dlog_headers INTERFACE IMPORTED)
  set_target_properties(dlog_headers PROPERTIES
    INTERFACE_INCLUDE_DIRECTORIES "${CV_INTERFACE_INCLUDE}"
  )
