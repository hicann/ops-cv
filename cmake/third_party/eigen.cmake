...
if (IS_DIRECTORY "${CANN_3RD_LIB_PATH}/eigen-5.0.0" AND NOT FORCE_REBUILD_CANN_3RD)
  message("[ThirdPartyLib][eigen] eigen-5.0.0 found, and not force rebuild cann third_party")
  set(SOURCE_DIR "${CANN_3RD_LIB_PATH}/eigen-5.0.0")
elseif (IS_DIRECTORY "${CANN_3RD_LIB_PATH}/eigen" AND NOT FORCE_REBUILD_CANN_3RD)
