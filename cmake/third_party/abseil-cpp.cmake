...
if(abseil-cpp_FOUND)
  ...
  if(EXISTS "${CANN_3RD_LIB_PATH}/${ABSEIL_VERSION_PKG}")
      ...
      message(STATUS "[ThirdPartyLib][abseil-cpp] moving ${ABSEIL_VERSION_PKG} from ${CANN_3RD_LIB_PATH} to ${CANN_3RD_LIB_PATH}/pkg/${ABSEIL_VERSION_PKG}")
  endif()

  # 初始化可选参数列表
  if(EXISTS "${CANN_3RD_LIB_PATH}/pkg/${ABSEIL_VERSION_PKG}")
        set(REQ_URL "${CANN_3RD_LIB_PATH}/pkg/${ABSEIL_VERSION_PKG}")
        message(STATUS "[ThirdPartyLib][abseil-cpp] found in file: ${REQ_URL}.")
