...
set(OPS_CV_CXX_FLAGS)
string(APPEND OPS_CV_CXX_FLAGS " ${COMPILE_OP_MODE}")
string(APPEND OPS_CV_CXX_FLAGS " -Wall")
string(APPEND OPS_CV_CXX_FLAGS " -Wextra")
string(APPEND OPS_CV_CXX_FLAGS " -Wshadow")
string(APPEND OPS_CV_CXX_FLAGS " -fno-common")
string(APPEND OPS_CV_CXX_FLAGS " -fPIC")
string(APPEND OPS_CV_CXX_FLAGS " -Wno-format -Wno-ignored-qualifiers -Wno-maybe-uninitialized -Wno-parentheses")
string(APPEND OPS_CV_CXX_FLAGS " -Wno-return-type -Wno-sign-compare -Wno-unused-but-set-variable")
string(APPEND OPS_CV_CXX_FLAGS " -Wno-unused-parameter -Wno-unused-value -Wno-unused-variable")
if(NOT "${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang")
  if(("${CMAKE_BUILD_TYPE}" STREQUAL "Debug") OR (${ENABLE_ASAN}))
    string(APPEND OPS_CV_CXX_FLAGS " -Wno-error")
  else()
    string(APPEND OPS_CV_CXX_FLAGS " -Werror")
    string(APPEND OPS_CV_CXX_FLAGS " -Wno-error=deprecated-declarations")
  endif()
  string(APPEND OPS_CV_CXX_FLAGS " -Wformat-signedness")
  string(APPEND OPS_CV_CXX_FLAGS " -Wno-unused-function")
  string(APPEND OPS_CV_CXX_FLAGS " -Wno-missing-include-dirs")
  string(APPEND OPS_CV_CXX_FLAGS " -Wno-write-strings")
endif()
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${OPS_CV_CXX_FLAGS}")
...
if(BUILD_WITH_INSTALLED_DEPENDENCY_CANN_PKG)
 	if(EXISTS "${ASCEND_CANN_PACKAGE_PATH}/${SYSTEM_PREFIX}/tikcpp/ascendc_kernel_cmake")
 	  ...
 	  if(NOT GenerateEsPackage_FOUND)
 	    ...
 	    message("================================================================")
 	    message("Refer to the 'Operator Invocation' chapter (environment preparation section) "
              "in the README and update the toolkit package to the latest version.")
 	    message("")
