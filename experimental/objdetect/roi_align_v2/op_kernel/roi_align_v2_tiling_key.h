...
/*!
 * \file roi_align_tiling_key.h
 * \brief roi_align tiling key declare
 */

#ifndef __ROI_ALIGN_V2_TILING_KEY_H__
#define __ROI_ALIGN_V2_TILING_KEY_H__
...
/* 模板参数 */
ASCENDC_TPL_ARGS_DECL(RoiAlignV2, ASCENDC_TPL_UINT_DECL(schMode, 1, ASCENDC_TPL_UI_LIST, ELEMENTWISE_TPL_SCH_MODE_0,
