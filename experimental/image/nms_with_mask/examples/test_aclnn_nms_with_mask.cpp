...
int main()
{
    ...
    std::vector<uint8_t> outHostData(21, 1);
    ...
    // 5. 调用aclnnNMSWithMask第二段接口
    ret = aclnnNMSWithMask(workspaceAddr, workspaceSize, executor, stream);
    CHECK_RET(ret == ACL_SUCCESS, LOG_PRINT("aclnnNMSWithMask failed. ERROR: %d\n", ret); return ret);
