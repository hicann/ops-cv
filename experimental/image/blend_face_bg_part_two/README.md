...
- 算子功能：根据人脸区域累积图、累积mask、最大mask与背景图计算融合结果。
- 计算公式：
...
| 调用方式 | 调用样例 | 说明 |
| -------- | -------- | ---- |
| aclnn调用 | examples/test_aclnn_blend_face_bg_part_two.cpp | aclnn调用示例。 |
