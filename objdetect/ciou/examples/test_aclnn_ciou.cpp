...
int main()
{
    ...
    CHECK_RET(ret == ACL_SUCCESS, LOG_PRINT("aclnnCIoUGetWorkspaceSize failed. ERROR: %d\n", ret); return ret);
    ...
    CHECK_RET(ret == ACL_SUCCESS, LOG_PRINT("aclnnCIoU failed. ERROR: %d\n", ret); return ret);
    ...
    CHECK_RET(ret == ACL_SUCCESS, LOG_PRINT("copy overlapData from device to host failed. ERROR: %d\n", ret);
              return ret);
    ...
    CHECK_RET(ret == ACL_SUCCESS, LOG_PRINT("copy atanSubData from device to host failed. ERROR: %d\n", ret);
              return ret);
