...
每个算子分为[两段式接口](../../../docs/zh/context/two_phase_api.md)，必须先调用“aclnnCIoUGetWorkspaceSize”接口获取计算所需workspace大小以及包含了算子计算流程的执行器，再调用“aclnnCIoU”接口执行计算。
...
- **返回值**
  ...
  <tbody>
    ...
    <tr>
      <td>bBoxes或gtBoxes的第二维不是1024的倍数。</td>
    </tr>
    <tr>
