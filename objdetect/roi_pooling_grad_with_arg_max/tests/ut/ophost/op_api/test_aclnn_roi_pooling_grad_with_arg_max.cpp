...
protected:
    static void SetUpTestCase() { cout << "roi_pooling_grad_with_arg_max_test SetUp" << endl; }

    static void TearDownTestCase() { cout << "roi_pooling_grad_with_arg_max_test TearDown" << endl; }
};
