...
#ifndef _ROI_POOLING_GRAD_WITH_ARG_MAX_TILING_KEY_DECL_H_
#define _ROI_POOLING_GRAD_WITH_ARG_MAX_TILING_KEY_DECL_H_

#define ROI_POOLING_GRAD_WITH_ARG_MAX_TPL_FP32 0
#define ROI_POOLING_GRAD_WITH_ARG_MAX_TPL_FP16 1
