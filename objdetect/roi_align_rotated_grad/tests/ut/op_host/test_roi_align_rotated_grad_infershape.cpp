...
protected:
    static void SetUpTestCase() { std::cout << "RoiAlignRotatedGrad Proto Test SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "RoiAlignRotatedGrad Proto Test TearDown" << std::endl; }
};
...
TEST_F(RoiAlignRotatedGrad, RoiAlignRotatedGrad_infershape_iou_false_case_0)
{
    gert::InfershapeContextPara infershapeContextPara(
        "RoiAlignRotatedGrad",
        {{{{8, 2, 2, 1}, {8, 2, 2, 1}}, ge::DT_FLOAT, ge::FORMAT_ND}, {{{6, 8}, {6, 8}}, ge::DT_FLOAT, ge::FORMAT_ND}},
        {
            {{{}, {}}, ge::DT_FLOAT, ge::FORMAT_ND},
        },
        {gert::InfershapeContextPara::OpAttr("y_grad_shape",
                                             Ops::Cv::AnyValue::CreateFrom<std::vector<int64_t>>({4, 8, 8, 1})),
...
//   Runtime2TestParam roi_align_rotated_grad_param{{"y_grad_shape", "pooled_h", "pooled_w", "spatial_scale",
//   "sampling_ratio", "aligned", "clockwise"}}; EXPECT_EQ(InferShapeTest(op, roi_align_rotated_grad_param),
//   ge::GRAPH_SUCCESS);
