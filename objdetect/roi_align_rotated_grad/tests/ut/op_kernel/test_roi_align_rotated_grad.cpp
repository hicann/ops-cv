...
extern "C" __global__ __aicore__ void roi_align_rotated_grad(GM_ADDR input, GM_ADDR rois, GM_ADDR output,
...
protected:
    ...
    static void TearDownTestCase() { cout << "roi_align_rotated_grad_test TearDown\n" << endl; }

private:
    const static std::string dataPath;
};

const std::string roi_align_rotated_grad_test::
    dataPath = "../../../../objdetect/roi_align_rotated_grad/tests/ut/op_kernel/roi_align_rotated_grad_data";
