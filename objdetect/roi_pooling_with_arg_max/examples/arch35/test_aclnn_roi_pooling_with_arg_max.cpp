...
int main()
{
    ...
    ret = aclnnRoiPoolingWithArgMaxGetWorkspaceSize(x, rois, pooledH, pooledW, spatialScaleH, spatialScaleW, y, argmax,
    ...
    ret = aclrtMemcpy(argmaxResult.data(), argmaxElem * sizeof(int32_t), argmaxDeviceAddr, argmaxElem * sizeof(int32_t),
                      ACL_MEMCPY_DEVICE_TO_HOST);
