...
protected:
    static void SetUpTestCase() { std::cout << "RoiPoolingWithArgMax Infershape Test SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "RoiPoolingWithArgMax Infershape Test TearDown" << std::endl; }
};
...
TEST_F(RoiPoolingWithArgMax, RoiPoolingWithArgMax_infershape_case_1)
{
    gert::InfershapeContextPara infershapeContextPara(
        ...
        {{{{}, {}}, ge::DT_FLOAT16, ge::FORMAT_ND}, {{{}, {}}, ge::DT_INT32, ge::FORMAT_ND}},
