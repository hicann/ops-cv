...
protected:
    static void SetUpTestCase() { cout << "l2_roi_pooling_with_arg_max_test SetUp" << endl; }
    static void TearDownTestCase() { cout << "l2_roi_pooling_with_arg_max_test TearDown" << endl; }
};
