...
protected:
    static void SetUpTestCase() { std::cout << "TilingForBlendImagesCustom SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "TilingForBlendImagesCustom TearDown" << std::endl; }
};
