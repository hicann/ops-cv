...
protected:
    static void SetUpTestCase() { std::cout << "BackgroundReplace Proto Test SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "BackgroundReplace Proto Test TearDown" << std::endl; }
};
