...
protected:
    static void SetUpTestCase() { std::cout << "test TestStackGroupPointsTiling SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "test TestStackGroupPointsTiling TearDown" << std::endl; }
};
