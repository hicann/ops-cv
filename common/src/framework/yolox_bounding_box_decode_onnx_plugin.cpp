...
namespace domi {
static Status ParseParamsYoloxBoundingBoxDecode(const ge::Operator& op_src, ge::Operator& op_dest) { return SUCCESS; }
...
REGISTER_CUSTOM_OP("YoloxBoundingBoxDecode")
    ...
    .ParseParamsByOperatorFn(ParseParamsYoloxBoundingBoxDecode)
