...
public:
    ...
    virtual void SetUp() {
        ...
        /* load libcv_op_kernel_ut_${socversion}_ut.so for init tiling funcs and infershape funcs */
        ...
        string opKernelTilingSoPath = buildPath + string("/tests/ut/op_kernel/libcv_op_kernel_ut_tiling.so");
        gert::OppSoDesc oppSoDesc({ge::AscendString(opKernelTilingSoPath.c_str())}, "cv_op_kernel_ut_so");
