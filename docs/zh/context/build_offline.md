...
# 以CropAndResize算子编译为例，假设第三方软件存放的目录为/path/cann_3rd_lib_path
# bash build.sh --pkg --soc=ascend910b --ops=crop_and_resize --cann_3rd_lib_path=/path/cann_3rd_lib_path
```
