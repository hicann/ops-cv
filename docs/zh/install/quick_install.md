...
2. 根据页面提示创建NPU环境并配置规格，启动云开发环境后，单击“`连接 > WebIDE`”进入一站式开发平台。当前开源项目资源默认在/mnt/workspace/gitCode目录。
...
2. **下载镜像**
   ...
   - 步骤2：从[昇腾镜像仓库](https://www.hiascend.com/developer/ascendhub/detail/17da20d1c2b6493cb38765adeba85884)拉取已预集成CANN软件包及`ops-cv`所需依赖的镜像。
