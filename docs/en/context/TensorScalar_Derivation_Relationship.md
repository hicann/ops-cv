# TensorScalar Derivation Relationship
...
The type derivation rules are as follows:
...
**Table 1** Data Type Derivation Relationship Table
...
- If the input Tensor data type is float16 and the input Scalar data type is float32, then the API internally converts the input Scalar float32 data type to float16 data type and then performs the calculation.
- If the input Tensor data type is bool and the input Scalar data type is float32, then the API internally converts the input Tensor bool data type to float32 data type and then performs the calculation.
