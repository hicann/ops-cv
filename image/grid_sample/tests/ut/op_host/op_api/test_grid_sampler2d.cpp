...
TEST_F(l2_grid_sampler2d_test, case_5)
{
    ...
    auto input = TensorDesc({1, 1, 5, 8}, dtype, ACL_FORMAT_ND)
                     .Value(vector<float>{0,
                         1,
                         2,
                         3,
...
{
    auto input = TensorDesc({1, 1, 5, 8}, ACL_FLOAT, ACL_FORMAT_NCHW)
                     .Value(vector<float>{0,
                         1,
                         2,
                         3,
...
{
    auto input = TensorDesc({1, 1, 5, 8}, ACL_FLOAT, ACL_FORMAT_HWCN)
                     .Value(vector<float>{0,
                         1,
                         2,
                         3,
...
{
    auto input = TensorDesc({1, 1, 5, 8}, ACL_DOUBLE, ACL_FORMAT_ND)
                     .Value(vector<float>{0,
                         1,
                         2,
                         3,
...
//
TEST_F(l2_grid_sampler2d_test, case_29)
{
    auto input = TensorDesc({1, 1, 5, 8}, ACL_FLOAT, ACL_FORMAT_ND)
                     .Value(vector<float>{0,
                         1,
    ...
    auto out = TensorDesc({1, 1, 3, 3}, ACL_FLOAT, ACL_FORMAT_ND);
    bool alignCorners = false;
    auto ut = OP_API_UT(aclnnGridSampler2D, INPUT(input, grid, 2, 0, alignCorners), OUTPUT(out));
...
{
    auto input = TensorDesc({1, 32, 1, 1}, ACL_FLOAT16, ACL_FORMAT_ND)
                     .Value(vector<float>{0,
                         1,
                         2,
                         3,
...
{
    auto input = TensorDesc({1, 1, 5, 8}, ACL_FLOAT16, ACL_FORMAT_ND)
                     .Value(vector<float>{0,
                         1,
                         2,
                         3,
...
{
    auto input = TensorDesc({1, 1, 5, 8}, ACL_BF16, ACL_FORMAT_ND)
                     .Value(vector<float>{0,
                         1,
                         2,
                         3,
