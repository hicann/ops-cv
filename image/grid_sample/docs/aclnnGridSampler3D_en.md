...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Input</td>
      <td>Sampling grid, corresponding to grid in the formula.</td>
    ...
    <tr>
      ...
      <td>If True, the extrema (-1 and 1) are considered as referring to the center points of the input's corner pixels. If False, they are instead considered as referring to the corner points of the input's corner pixels.</td>
      <td>-</td>
      <td>-</td>
      <td>-</td>
      <td>-</td>
    ...
    <tr>
      ...
      <td><ul><li>Empty tensors are supported. </li><li>The data format and type are the same as those of the input. </li><li>The N and C axes of the shape are the same as those of the input, and the D, H, and W axes of the shape are the same as those of the grid.</li></ul></td>
      <td>FLOAT16, FLOAT32, DOUBLE, BFLOAT16</td>
      <td>NCDHW, NDHWC, ND</td>
      <td>5</td>
      <td>√</td>
