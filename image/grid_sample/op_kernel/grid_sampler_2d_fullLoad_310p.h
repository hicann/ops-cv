...
template <typename T>
__aicore__ inline void GridSampler2DFullLoad310P<T>::ZeroClip(LocalTensor<float> tmpLocal)
{
    ...
    PipeBarrier<PIPE_V>();
    CoordinatesSelectScalar(tmpLocal3, tmpLocal3, maskUb, -100.0f, calHWBlockAlign);
    PipeBarrier<PIPE_V>();
    ...
    Compare(maskUb, tmpLocal5, tmpLocal5, CMPMODE::EQ, calHWBlockAlign);
    PipeBarrier<PIPE_V>();
    CoordinatesSelectScalar(tmpLocal4, tmpLocal4, maskUb, -100.0f, calHWBlockAlign);
    PipeBarrier<PIPE_V>();
}
