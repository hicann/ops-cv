...
#include "arch35/grid_sampler_3d_bilinear_smit.h"
...
extern "C" __global__ __aicore__ void grid_sample(GM_ADDR x, GM_ADDR grid, GM_ADDR y, GM_ADDR workspace, GM_ADDR tiling)
{
    ...
    TILING_KEY_IS(1000211);
    TILING_KEY_IS(1001211);
    TILING_KEY_IS(1000231);
    TILING_KEY_IS(1001231);
    TILING_KEY_IS(1000222);
    TILING_KEY_IS(1001222);
    TILING_KEY_IS(1000212);
    TILING_KEY_IS(1001212);
    TILING_KEY_IS(1000232);
    TILING_KEY_IS(1001232);
    TILING_KEY_IS(1001220);
    TILING_KEY_IS(1000210);
    TILING_KEY_IS(1001210);
    TILING_KEY_IS(1000230);
    TILING_KEY_IS(1001230);
    TILING_KEY_IS(2000220);
    TILING_KEY_IS(2001220);
    TILING_KEY_IS(2000210);
    TILING_KEY_IS(2001210);
    TILING_KEY_IS(2000230);
    TILING_KEY_IS(2001230);
    TILING_KEY_IS(2100220);
    TILING_KEY_IS(2101220);
    TILING_KEY_IS(2100210);
    TILING_KEY_IS(2101210);
    TILING_KEY_IS(2100230);
    TILING_KEY_IS(2101230);
    TILING_KEY_IS(2200220);
    TILING_KEY_IS(2201220);
    TILING_KEY_IS(2200210);
    TILING_KEY_IS(2201210);
    TILING_KEY_IS(2200230);
    TILING_KEY_IS(2201230);
    TILING_KEY_IS(1010320);
    TILING_KEY_IS(1010310);
    TILING_KEY_IS(1010330);
    TILING_KEY_IS(1011330);
    TILING_KEY_IS(1010321);
    TILING_KEY_IS(1011321);
    TILING_KEY_IS(1010311);
    TILING_KEY_IS(1011311);
    TILING_KEY_IS(1010331);
    TILING_KEY_IS(1011331);
    TILING_KEY_IS(1011320);
    TILING_KEY_IS(1011310);
        ...
        GridSampler2dBilinearSimt<DTYPE_X, uint32_t, int32_t> gridSampler2dKernel;
        gridSampler2dKernel.Init(x, grid, y, workspace, tilingData);
        gridSampler2dKernel.Process();
    #elif TILING_KEY_VAR == 1100
                GET_TILING_DATA_WITH_STRUCT(GridSampleTilingData, tiling_data_in, tiling);
        const GridSampleTilingData* __restrict tilingData = &tiling_data_in;
        GridSampler2dBilinearSimt<DTYPE_X, uint64_t, int64_t> gridSampler2dKernel;
        gridSampler2dKernel.Init(x, grid, y, workspace, tilingData);
        gridSampler2dKernel.Process();
    #elif TILING_KEY_VAR == 2000
        GET_TILING_DATA_WITH_STRUCT(GridSampleTilingData, tiling_data_in, tiling);
        const GridSampleTilingData* __restrict tilingData = &tiling_data_in;
        GridSampler3dBilinearSimt<DTYPE_X, uint32_t, int32_t> gridSampler3dKernel;
        gridSampler3dKernel.Init(x, grid, y, workspace, tilingData);
        gridSampler3dKernel.Process();
    #elif TILING_KEY_VAR == 2100
        GET_TILING_DATA_WITH_STRUCT(GridSampleTilingData, tiling_data_in, tiling);
        const GridSampleTilingData* __restrict tilingData = &tiling_data_in;
        GridSampler3dBilinearSimt<DTYPE_X, uint64_t, int64_t> gridSampler3dKernel;
        gridSampler3dKernel.Init(x, grid, y, workspace, tilingData);
        gridSampler3dKernel.Process();
