...
#ifndef OP_API_INC_UPSAMPLE_BILINEAR_H_
#define OP_API_INC_UPSAMPLE_BILINEAR_H_
 ...
 */
ACLNN_API aclnnStatus aclnnUpsampleBilinear2d(
...
#endif  // OP_API_INC_UPSAMPLE_BILINEAR_H_