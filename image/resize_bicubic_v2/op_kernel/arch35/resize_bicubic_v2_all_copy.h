...
/*!
 * \file resize_bicubic_v2_all_copy.h
 * \brief resize_bicubic_v2_all_copy
 */
#ifndef RESIZE_BICUBIC_V2_ALL_COPY_H
#define RESIZE_BICUBIC_V2_ALL_COPY_H
...
class ResizeBicubicV2AllCopy : public ResizeBicubicV2Base {
public:
...
template <typename T_DATA, uint64_t halfPixel, uint64_t mode, typename T_IDX, typename T_IDX2>
__aicore__ inline void ResizeBicubicV2AllCopy<T_DATA, halfPixel, mode, T_IDX, T_IDX2>::Process()
{
