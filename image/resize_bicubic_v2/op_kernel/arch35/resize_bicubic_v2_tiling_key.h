...
#define RESIZE_BICUBIC_V2_TPL_KEY_DECL()                                                                        \
    ASCENDC_TPL_UINT_DECL(schId, ASCENDC_TPL_8_BW, ASCENDC_TPL_UI_LIST, RESIZE_BICUBIC_V2_TPL_SCH_MODE_0,       \
                          RESIZE_BICUBIC_V2_TPL_SCH_MODE_1, RESIZE_BICUBIC_V2_TPL_SCH_MODE_2,                   \
                          RESIZE_BICUBIC_V2_TPL_SCH_MODE_3, RESIZE_BICUBIC_V2_TPL_SCH_MODE_4,                   \
                          RESIZE_BICUBIC_V2_TPL_SCH_MODE_5, RESIZE_BICUBIC_V2_TPL_SCH_MODE_6),                  \
        ASCENDC_TPL_UINT_DECL(isInt32, ASCENDC_TPL_8_BW, ASCENDC_TPL_UI_LIST, RESIZE_BICUBIC_V2_TPL_INT32_0,    \
                              RESIZE_BICUBIC_V2_TPL_INT32_1),                                                   \
        ASCENDC_TPL_UINT_DECL(isHalfPixel, ASCENDC_TPL_8_BW, ASCENDC_TPL_UI_LIST, RESIZE_BICUBIC_V2_TPL_HALF_0, \
                              RESIZE_BICUBIC_V2_TPL_HALF_1),                                                    \
        ASCENDC_TPL_UINT_DECL(isNchw, ASCENDC_TPL_8_BW, ASCENDC_TPL_UI_LIST, RESIZE_BICUBIC_V2_TPL_NCHW_0,      \
                              RESIZE_BICUBIC_V2_TPL_NCHW_1)
...
#define RESIZE_BICUBIC_V2_NHWC_TPL_KEY_SEL()                                                  \
    ASCENDC_TPL_UINT_SEL(schId, ASCENDC_TPL_UI_LIST, 0, RESIZE_BICUBIC_V2_TPL_SCH_MODE_2,     \
                         RESIZE_BICUBIC_V2_TPL_SCH_MODE_3, RESIZE_BICUBIC_V2_TPL_SCH_MODE_4), \
        ASCENDC_TPL_UINT_SEL(isInt32, ASCENDC_TPL_UI_RANGE, 1, 0, 1),                         \
        ASCENDC_TPL_UINT_SEL(isHalfPixel, ASCENDC_TPL_UI_RANGE, 1, 0, 1),                     \
...
#define RESIZE_BICUBIC_V2_SIMD_TPL_KEY_SEL()                                           \
    ASCENDC_TPL_UINT_SEL(schId, ASCENDC_TPL_UI_LIST, RESIZE_BICUBIC_V2_TPL_SCH_MODE_5, \
