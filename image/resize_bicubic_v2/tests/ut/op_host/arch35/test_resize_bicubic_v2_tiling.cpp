...
static inline int64_t GetIsNchwFromTilingKey(int64_t tilingKey)
{
    return (tilingKey >> 24) & 0xFF;
}
static inline int64_t GetIsInt32FromTilingKey(int64_t tilingKey)
{
    return (tilingKey >> 8) & 0xFF;
}
