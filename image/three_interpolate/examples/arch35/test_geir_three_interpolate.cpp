...
#include "../../op_graph/three_interpolate_proto.h"
                     ...
                     std::vector<Operator>& outputs, Graph& graph)
{
    Status ret = SUCCESS;
    // 自定义代码：添加单算子定义到图中
    auto add1 = op::ThreeInterpolate("add1");
    std::vector<int64_t> featuresShape = {2, 4, 3};
    std::vector<int64_t> idxShape = {2, 2, 3};
    std::vector<int64_t> weightShape = {2, 2, 3};
    std::vector<int64_t> outputShape = {2, 2, 3};
    ADD_INPUT(1, features, inDtype, featuresShape);
    ADD_INPUT(2, idx, DT_INT32, idxShape);
    ADD_INPUT(3, weight, inDtype, weightShape);

    ADD_OUTPUT(1, y, inDtype, outputShape);
