...
protected:
    static void SetUpTestCase() { std::cout << "l2_upsamplelinear1d_test SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "l2_upsamplelinear1d_test TearDown" << std::endl; }
};
