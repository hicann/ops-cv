 ...
 */
#ifndef OP_API_INC_UPSAMPLE_LINEAR_H_
#define OP_API_INC_UPSAMPLE_LINEAR_H_
 ...
 */
ACLNN_API aclnnStatus aclnnUpsampleLinear1d(
...
#endif  // OP_API_INC_UPSAMPLE_LINEAR_H_