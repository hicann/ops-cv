...
TEST_F(UpsampleNearestTiling, upsample_nearest2d_tiling_001)
{
    ...
    std::string op_type("UpsampleNearest");
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeAttrs(
                          {{"output_size", ge::AnyValue::CreateFrom<std::vector<int64_t>>(output_size)},
                           ...
                           {"exact_mode", ge::AnyValue::CreateFrom<bool>(true)}})
...
{
    dlog_setlevel(0, 0, 0);
    gert::StorageShape input_shape = {{1, 4, 16, 16}, {1, 4, 16, 16}};
    gert::StorageShape out_shape = {{1, 16, 32, 16}, {1, 16, 32, 16}};
    ...
    auto ws_size = reinterpret_cast<gert::ContinuousVector*>(workspace_size_holer.get());
    ASSERT_NE(param, nullptr);
    std::vector<int64_t> output_size = {16, 32};
    auto holder = gert::TilingContextFaker()
                      .SetOpType("UpsampleNearest")
                      .NodeIoNum(1, 1)
                      .IrInstanceNum({1})
...
TEST_F(UpsampleNearestTiling, upsample_nearest2d_tiling_003)
{
    dlog_setlevel(0, 0, 0);
    gert::StorageShape input_shape = {{1, 128, 128, 2}, {1, 128, 128, 2}};
    gert::StorageShape out_shape = {{1, 256, 512, 2}, {1, 256, 512, 2}};
    ...
    auto ws_size = reinterpret_cast<gert::ContinuousVector*>(workspace_size_holer.get());
    ASSERT_NE(param, nullptr);
    std::vector<int64_t> output_size = {256, 512};
    auto holder = gert::TilingContextFaker()
                      .SetOpType("UpsampleNearest")
                      .NodeIoNum(1, 1)
                      .IrInstanceNum({1})
...
TEST_F(UpsampleNearestTiling, upsample_nearest2d_tiling_004)
{
    dlog_setlevel(0, 0, 0);
    gert::StorageShape input_shape = {{1, 1, 128, 1}, {1, 1, 128, 1}};
    gert::StorageShape out_shape = {{1, 1, 512, 1}, {1, 1, 512, 1}};
    ...
    auto ws_size = reinterpret_cast<gert::ContinuousVector*>(workspace_size_holer.get());
    ASSERT_NE(param, nullptr);
    std::vector<int64_t> output_size = {1, 256};
    auto holder = gert::TilingContextFaker()
                      .SetOpType("UpsampleNearest")
                      .NodeIoNum(1, 1)
                      .IrInstanceNum({1})
