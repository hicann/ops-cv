...
[📄 View source code](https://gitcode.com/cann/ops-cv/tree/master/image/upsample_nearest)
...
- **Parameters:**
  ...
  <tbody>
    <tr>
      <td>self</td>
      <td>Input</td>
      <td>Input tensor for upsampling, corresponding to the input `self` in the formula.</td>
    ...
    <tr>
      <td>outputSize</td>
      <td>Input</td>
      <td>Spatial size of `out` in the H and W dimensions, corresponding to `outputSize` in the formula.</td>
      <td>The size is 2.</td>
      <td>INT64</td>
      <td>-</td>
      <td>-</td>
    ...
    <tr>
      <td>scalesH</td>
      <td>Input</td>
      <td>Scaling multiplier for spatial size in the H direction, corresponding to `scalesH` in the formula.</td>
    ...
    <tr>
      <td>scalesW</td>
      <td>Input</td>
      <td>Scaling multiplier for spatial size in the W direction, corresponding to `scalesW` in the formula.</td>
      <td>The value cannot be negative.</td>
      <td>DOUBLE</td>
      <td>-</td>
      <td>-</td>
    ...
    <tr>
      ...
      <td><ul><li>Empty tensors are supported. </li><li>The data type is the same as that of the input parameter `self`.</li></ul></td>
      <td>FLOAT32, FLOAT16, BFLOAT16</td>
      <td>NCHW, NHWC, ND</td>
      <td>4</td>
      <td>√</td>
...
- **Parameters:**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnUpsampleNearestExact2dGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
int main() {
    ...
    aclOpExecutor* executor;
    // Call the first-phase API of aclnnUpsampleNearestExact2d.
    ...
    // Call the second-phase API of aclnnUpsampleNearestExact2d.
