...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnUpsampleNearestExact1dGetWorkspaceSize** is called to obtain the workspace size required for computation and the executor that contains the operator computation process. Then, aclnnUpsampleNearestExact1d is called to perform computation.
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Input</td>
      <td>Spatial size of out in the L dimension.</td>
      <td>The value of size is 1 and is greater than 0.</td>
      <td>INT64</td>
      <td>-</td>
      <td>-</td>
      <td>-</td>
    ...
    <tr>
      <td>scales (double)</td>
      <td>Input</td>
      <td>Scaling multiplier for spatial size, corresponding to the input scales in the formula.</td>
      <td>-</td>
      <td>-</td>
      <td>-</td>
      <td>-</td>
    ...
    <tr>
      ...
      <td><ul><li>Empty tensors are not supported. </li><li>The data type and format must be the same as those of the input self.</li></ul></td>
      <td>FLOAT32, FLOAT16, BFLOAT16</td>
      <td>NCL and ND</td>
      <td>3</td>
      <td>√</td>
...
- **Returns:**
  ...
  <tbody>
    ...
    <tr>
      <td>The shape of self is not 3D.</td>
    </tr>
  </tbody></table>
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnUpsampleNearestExact1dGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
int main() {
    ...
    aclOpExecutor* executor;
    // Call the first-phase API of aclnnUpsampleNearestExact1d.
    ...
    // Call the second-phase API of aclnnUpsampleNearestExact1d.
