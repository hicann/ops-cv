...
每个算子分为[两段式接口](../../../docs/zh/context/two_phase_api.md)，必须先调用“aclnnUpsampleNearestExact2dGetWorkspaceSize”接口获取计算所需workspace大小以及包含了算子计算流程的执行器，再调用“aclnnUpsampleNearestExact2d”接口执行计算。
...
- **参数说明**
  ...
  - <term>Atlas 推理系列产品</term>：
    ...
    参数self、out的数据类型不支持BFLOAT16、UINT8。
  <!-- end id7 -->
