...
TILING_DATA_FIELD_DEF_ARR(int64_t, MAX_CORE_CONT, tailColStartList);
TILING_DATA_FIELD_DEF_ARR(int64_t, MAX_CORE_CONT, tailColEndList);
TILING_DATA_FIELD_DEF_ARR(int64_t, MAX_CORE_CONT, tailRowStartList);
TILING_DATA_FIELD_DEF_ARR(int64_t, MAX_CORE_CONT, tailRowEndList);
