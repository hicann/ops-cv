...
static bool CheckInputElement(const aclTensor* gradOutput, const aclIntArray* inputSize, double scales)
{
                                                                ...
                                                                aclOpExecutor** executor)
{
    ...
    L2_DFX_PHASE_1(aclnnUpsampleNearestExact1dBackward, DFX_IN(gradOutput, outputSize, inputSize, scales),
                   DFX_OUT(out));
    // 固定写法，创建OpExecutor
