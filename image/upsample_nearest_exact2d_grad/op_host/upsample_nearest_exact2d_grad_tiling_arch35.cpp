...
ge::graphStatus UpsampleNearestExact2dGradRegbaseTiling::CheckInputShapeAndAttr()
{
    ...
    OP_CHECK_IF(gradOutputSizeAttr == nullptr, OP_LOGE(tilingContext, "GradOutputSize is nullptr"), return ge::GRAPH_FAILED);

    auto gradInputSize = attrs->GetAttrPointer<gert::ContinuousVector>(CONST_1);
    OP_CHECK_IF(
        gradInputSize == nullptr, OP_LOGE(tilingContext, "GradInputSize is nullptr"), return ge::GRAPH_FAILED);
    ...
    OP_CHECK_IF(
        (baseTiling.outH != outH) || (baseTiling.outW != outW),
...
void UpsampleNearestExact2dGradRegbaseTiling::PrintTilingData()
{
    OP_LOGD(
        ...
        tilingData->inH, tilingData->inW, tilingData->outH, tilingData->outW, tilingData->scaleH, tilingData->scaleW);
}
...
ge::graphStatus UpsampleNearestExact2dGradRegbaseTiling::Init()
{
    ...
    OP_CHECK_IF(
        (memset_s(
             tilingData, sizeof(UpsampleNearestExact2dGradRegBaseTilingData), 0,
