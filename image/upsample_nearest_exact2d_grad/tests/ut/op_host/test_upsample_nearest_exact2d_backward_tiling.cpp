...
#include "image/upsample_nearest_exact2d_grad/op_host/upsample_nearest_exact2d_grad_tiling.h"
...
TEST_F(UpsampleNearestExact2dGradTiling, upsample_upsample_nearest_exact2d_grad_tiling_001)
{
    ...
    std::string op_type("UpsampleNearestExact2dGrad");
    ...
    auto holder = gert::TilingContextFaker()
                      .SetOpType("UpsampleNearestExact2dGrad")
                      .NodeIoNum(1, 1)
                      .IrInstanceNum({1})
...
TEST_F(UpsampleNearestExact2dGradTiling, upsample_nearest_exact2d_grad_tiling_002)
{
    dlog_setlevel(0, 0, 0);
    gert::StorageShape input_shape = {{1, 1, 128, 128}, {1, 1, 128, 128}};
