...
TEST_F(upsample_nearest_exact2d_grad_test, test_case_float16)
{
    ...
    system("cd ./upsample_nearest_exact2d_grad_data/ && python3 compare_data.py 'float16'");
}
...
TEST_F(upsample_nearest_exact2d_grad_test, test_case_bfloat16)
{
    ...
    size_t inputByteSize = 4 * 4 * sizeof(bfloat16_t);
    size_t outputByteSize = 16 * 16 * sizeof(bfloat16_t);
    size_t tiling_data_size = sizeof(UpsampleNearestExact2dGradTilingData);
    size_t workspaceSize = 32 * 1024 * 1024;
    uint32_t numBlocks = 1;
    ...
    system("cd ./upsample_nearest_exact2d_grad_data/ && python3 compare_data.py 'bfloat16'");
}