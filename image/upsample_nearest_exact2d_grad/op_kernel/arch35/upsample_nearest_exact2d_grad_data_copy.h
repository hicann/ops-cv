...
/* !
 * \file upsample_nearest_exact2d_grad_data_copy.h
 * \brief upsample_nearest_exact2d_grad_data_copy.h
 */
#ifndef UPSAMPLE_NEAREST_EXACT2D_GRAD_DATA_COPY_H
#define UPSAMPLE_NEAREST_EXACT2D_GRAD_DATA_COPY_H
...
class NearestExact2dGradDataCopy {
public:
...
template <typename T1>
__aicore__ inline void NearestExact2dGradDataCopy<T1>::Init(
...
template <typename T1>
__aicore__ inline void NearestExact2dGradDataCopy<T1>::CopyIn(int64_t xOffsetInGM, int64_t length)
{
...
template <typename T1>
__aicore__ inline void NearestExact2dGradDataCopy<T1>::CopyOut(int64_t yOffsetInGM, int64_t length)
{
...
#endif // UPSAMPLE_NEAREST_EXACT2D_GRAD_DATA_COPY_H
