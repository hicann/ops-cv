...
每个算子分为[两段式接口](../../../docs/zh/context/two_phase_api.md)，必须先调用“aclnnUpsampleTrilinear3dGetWorkspaceSize”接口获取计算所需workspace大小以及包含了算子计算流程的执行器，再调用“aclnnUpsampleTrilinear3d”接口执行计算。
...
- **参数说明**
  ...
  - <term>Ascend 950PR/Ascend 950DT</term>：
    ...
    入参`self`和出参`out`的数据类型不支持DOUBLE。
  <!-- end id9 -->
...
int main()
{
    ...
    ret = aclnnUpsampleTrilinear3dGetWorkspaceSize(self, outputSize, alignCorners, scalesD, scalesH, scalesW, out,
