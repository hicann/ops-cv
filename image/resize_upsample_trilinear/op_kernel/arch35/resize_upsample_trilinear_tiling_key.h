...
ASCENDC_TPL_ARGS_DECL(ResizeUpsampleTrilinear,
    ASCENDC_TPL_UINT_DECL(dtypeKey, ASCENDC_TPL_8_BW, ASCENDC_TPL_UI_LIST, TPL_DTYPE_FP32, TPL_DTYPE_FP16, TPL_DTYPE_BF16)
);

ASCENDC_TPL_SEL(
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_UINT_SEL(dtypeKey, ASCENDC_TPL_UI_RANGE, 1, TPL_DTYPE_FP32, TPL_DTYPE_BF16)));
