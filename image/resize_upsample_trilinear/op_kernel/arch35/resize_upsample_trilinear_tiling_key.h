...
#define RESIZE_UPSAMPLE_TRILINEAR_SCH_MODE_D_ONLY 2
#define RESIZE_UPSAMPLE_TRILINEAR_SCH_MODE_COPY 3
#define RESIZE_UPSAMPLE_TRILINEAR_SCH_MODE_NC_HW 4
#define RESIZE_UPSAMPLE_TRILINEAR_SCH_MODE_FULL_3D_SIMD 5
#define RESIZE_UPSAMPLE_TRILINEAR_SCH_MODE_D_REUSE_NC_HW 6
...
#define RESIZE_UPSAMPLE_TRILINEAR_TPL_KEY_DECL()                                                                     \
    ASCENDC_TPL_UINT_DECL(schId, ASCENDC_TPL_8_BW, ASCENDC_TPL_UI_LIST, RESIZE_UPSAMPLE_TRILINEAR_SCH_MODE_NCDHW,    \
                          RESIZE_UPSAMPLE_TRILINEAR_SCH_MODE_D_ONLY, RESIZE_UPSAMPLE_TRILINEAR_SCH_MODE_COPY,        \
                          RESIZE_UPSAMPLE_TRILINEAR_SCH_MODE_NC_HW, RESIZE_UPSAMPLE_TRILINEAR_SCH_MODE_FULL_3D_SIMD, \
                          RESIZE_UPSAMPLE_TRILINEAR_SCH_MODE_D_REUSE_NC_HW),                                         \
