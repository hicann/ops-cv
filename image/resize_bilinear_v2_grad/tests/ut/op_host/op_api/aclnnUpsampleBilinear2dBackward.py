...
def gen_golden(case_info: dict):
  ...
  scales_h = input_desc[4]["value"]
  scales_w = input_desc[5]["value"]

  output = torch.ops.aten.upsample_bilinear2d_backward(self_tensor, output_size_desc, input_size_desc, align_corners, scales_h, scales_w)
