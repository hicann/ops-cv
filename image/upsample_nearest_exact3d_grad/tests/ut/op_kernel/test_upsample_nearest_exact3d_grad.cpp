...
TEST_F(upsample_nearest_exact3d_grad_test, test_case_float16_1)
{
    ...
    std::string fileName = "./upsample_nearest_exact3d_grad_data/float16_input_upsample_nearest_exact3d_grad.bin";
    ...
    tilingDatafromBin->scaleD = 1;
    tilingDatafromBin->needResizeH = false;
    tilingDatafromBin->needResizeW = true;
    tilingDatafromBin->needResizeD = false;
    ...
    tilingDatafromBin->gradInputShapes[0] = 16;
    tilingDatafromBin->gradInputShapes[1] = 16;
    tilingDatafromBin->gradInputShapes[2] = 16;
    tilingDatafromBin->gradOutputShapes[0] = 16;
    tilingDatafromBin->gradOutputShapes[1] = 16;
    tilingDatafromBin->gradOutputShapes[2] = 16;
    ...
    AscendC::GmFree((void*)workspace);
    AscendC::GmFree((void*)tiling);
    system("cd ./upsample_nearest_exact3d_grad_data/ && python3 compare_data.py 'float16'");
}