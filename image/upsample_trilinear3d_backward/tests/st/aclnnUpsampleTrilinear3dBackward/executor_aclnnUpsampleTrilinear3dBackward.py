...
@register("upsample_trilinear3dBackward")
class FunctionTorchUpsampleTrilinear3dBackwardApi(FunctionApi):
    ...
    def __call__(self, input_data: InputDataset, with_output: bool = False):
        ...
        if self.device == "gpu":
            ...
            device = "cpu"
        if device:
            input_data.kwargs['input'].to(device).requires_grad_(True)
