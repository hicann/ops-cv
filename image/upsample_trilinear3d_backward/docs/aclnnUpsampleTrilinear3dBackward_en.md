...
[📄 View source code](https://gitcode.com/cann/ops-cv/tree/master/image/upsample_trilinear3d_backward)
...
- Function: Performs backpropagation of [aclnnUpsampleTrilinear3d.md](../../resize_upsample_trilinear/docs/aclnnUpsampleTrilinear3d_en.md).
...
- Formula:
  ...
  - Calculation logic:
    ...
    - Assume that the output image **out** $(x, y, z)$ for forward interpolation is affected by the original image **input** $(x_i, y_j, z_k)$. Then:
...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnUpsampleTrilinear3dBackwardGetWorkspaceSize** is called to obtain the workspace size required for computation and the executor that contains the operator computation process. Then, **aclnnUpsampleTrilinear3dBackward** is called to perform computation.
...
- **Parameters:**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>The size is 5, and the last three elements are greater than 0.</td>
      <td>INT64</td>
      <td>-</td>
      <td>-</td>
      <td>-</td>
    ...
    <tr>
      <td>scalesD</td>
      <td>Input</td>
      <td>Multiplier for the output `gradInput` in the depth dimension, corresponding to `scales_d` in the formula.</td>
      <td>-</td>
      <td>DOUBLE</td>
      <td>-</td>
      <td>-</td>
    ...
    <tr>
      <td>scalesH</td>
      <td>Input</td>
      <td>Multiplier for the output `gradInput` in the height dimension, corresponding to `scales_h` in the formula.</td>
      <td>-</td>
      <td>DOUBLE</td>
      <td>-</td>
      <td>-</td>
    ...
    <tr>
      <td>scalesW</td>
      <td>Input</td>
      <td>Multiplier for the output `gradInput` in the width dimension, corresponding to `scales_w` in the formula.</td>
      <td>-</td>
      <td>DOUBLE</td>
      <td>-</td>
      <td>-</td>
    ...
    <tr>
      ...
      <td><ul><li>Empty tensors are not supported. </li><li>The sizes of shape in the N, C, D, H, and W dimensions must be the same as the spatial sizes in the N, C, D, H, and W dimensions specified by `inputSize`. </li><li>The data type and format must be the same as those of `gradOut`.</li></ul></td>
      <td>FLOAT32, FLOAT16, BFLOAT16, DOUBLE</td>
      <td>NCDHW, NDHWC, ND</td>
      <td>5</td>
      <td>√</td>
...
- **Returns:**
  ...
  **aclnnStatus**: status code. For details, see [aclnn Return Codes](../../../docs/en/context/aclnn_return_codes_cv.md).
  ...
  <tbody>
    ...
    <tr>
      <td>One of the last three elements of inputSize is less than or equal to 0.</td>
    </tr>
    <tr>
    ...
    <tr>
      <td>The shape of gradInput is inconsistent with that of inputSize[0], inputSize[1], inputSize[2], inputSize[3], and inputSize[4].</td>
    </tr>
  </tbody></table>
...
- **Parameters:**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnUpsampleTrilinear3dBackwardGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
- Either the D/H/W axes of **outputSize** or **scalesD**/**scalesH**/**scalesW** must be used.
  ...
  - If **alignCorners** is set to **False**:
    - If the value of the input parameter **scalesD**, **scalesH**, or **scalesW** is less than or equal to 0, the value of the corresponding axis in the input parameter **outputSize** is used, that is, $scales = (inputSize/outputSize)$.
    - If the value of **scalesD**, **scalesH**, or **scalesW** is greater than 0, the value of **scalesD**, **scalesH**, or **scalesW** is used. That is, the value of the corresponding axis of **outputSize** is $floor(inputSize\_D * scalesD)$, $floor(inputSize\_H * scalesH)$, or $floor(inputSize\_W * scalesW)$.
...
int main()
{
    ...
    aclOpExecutor* executor;
    // Call the first-phase API of aclnnUpsampleTrilinear3dBackward.
    ...
    // Call the second-phase API of aclnnUpsampleTrilinear3dBackward.
