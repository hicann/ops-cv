...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><ul><li>Empty tensors are not supported. </li><li>The sizes of shape in the N, C, D, H, and W dimensions must be the same as the spatial sizes in the N, C, D, H, and W dimensions specified by inputSize. </li><li> The data type, data format, and shape must be the same as those of the input parameter gradOut.</li></ul></td>
      <td>FLOAT32, FLOAT16, BFLOAT16, DOUBLE</td>
      <td>NCDHW, NDHWC, ND</td>
      <td>5</td>
      <td>√</td>
