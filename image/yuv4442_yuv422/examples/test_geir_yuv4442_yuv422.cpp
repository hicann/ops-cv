...
#include "../op_graph/yuv4442_yuv422_proto.h"
                     ...
                     std::vector<Operator>& outputs, Graph& graph)
{
    Status ret = SUCCESS;
    // 自定义代码：添加单算子定义到图中
    auto add1 = op::Yuv4442yuv422("yuv4442_yuv422_1");
    std::vector<int64_t> xShape = {2, 4, 4};
    ADD_INPUT(1, x, inDtype, xShape);

    std::vector<int64_t> yShape = {2, 4, 2};
    ADD_OUTPUT(1, y, DT_UINT8, yShape);
