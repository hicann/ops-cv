...
[📄 View source code](https://gitcode.com/cann/ops-cv/tree/master/image/upsample_nearest3d_grad)
...
- Function: Performs backpropagation of [aclnnUpsampleNearest3d](../../upsample_nearest3d/docs/aclnnUpsampleNearest3d_en.md).
- Formulas:
...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, aclnnUpsampleNearest3dBackwardGetWorkspaceSize is called to obtain the input parameters and compute the required workspace size based on the process. Then, aclnnUpsampleNearest3dBackward is called to perform computation.
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Input</td>
      <td>Spatial size of the input gradOut in the D, H, and W dimensions.</td>
    ...
    <tr>
      ...
      <td>Input</td>
      <td>Size of the output gradInput space.</td>
      <td><ul><li>The size is 5, and the last two elements are greater than 0. </li><li>If the input gradOut is in NCDHW format, it indicates the spatial size of the output gradInput in the N, C, D, H, and W dimensions. If the input gradOut is in NDHWC format, it indicates the spatial size of the output gradInput in the N, D, H, W, and C dimensions.</li></ul></td>
      <td>INT64</td>
      <td>-</td>
      <td>-</td>
      <td>-</td>
    ...
    <tr>
      ...
      <td><ul><li>Empty tensors are not supported. </li><li>The data type and format are the same as those of the input parameter gradOut.</li></ul></td>
      <td>FLOAT32, FLOAT16, DOUBLE, BFLOAT16</td>
      <td>NCDHW and NDHWC</td>
      <td>5</td>
      <td>√</td>
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnUpsampleNearest3dBackwardGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
int main()
{
    ...
    aclOpExecutor* executor;
    // Call the first-phase API of aclnnUpsampleNearest3dBackward.
    ...
    // Call the second-phase API of aclnnUpsampleNearest3dBackward.
