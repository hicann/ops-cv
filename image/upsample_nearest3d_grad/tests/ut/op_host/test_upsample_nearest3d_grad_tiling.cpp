...
#include "image/upsample_nearest3d_grad/op_host/upsample_nearest3d_grad_tiling.h"
...
TEST_F(UpsampleNearest3dGradTiling, upsample_nearest3d_grad_tiling_001)
{
    ...
    gert::StorageShape out_shape = {{1, 1, 256, 256, 256}, {1, 1, 256, 256, 256}};
    ...
    std::string op_type("UpsampleNearest3dGrad");
    ...
    std::vector<int64_t> output_size = {256, 256, 256};
    std::vector<int64_t> input_size = {1, 1, 128, 128, 128};
    std::vector<float> scales = {0.0, 0.0, 0.0};
    auto holder = gert::TilingContextFaker()
                      .SetOpType("UpsampleNearest3dGrad")
                      .NodeIoNum(1, 1)
                      .IrInstanceNum({1})
