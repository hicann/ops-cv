...
TEST_F(UpsampleNearest3dGradTiling, upsample_nearest3d_grad_tiling_001)
{
    ...
    gert::TilingContextPara tilingContextPara("UpsampleNearest3dGrad",
        ...
        {gert::TilingContextPara::OpAttr(
            ...
            gert::TilingContextPara::OpAttr(
                "scales", Ops::Cv::AnyValue::CreateFrom<std::vector<float>>({0.0, 0.0, 0.0}))},
        &compileInfo);
    uint64_t expectTilingKey = 1;
    string expectTilingData =
        "2 1 128 128 128 128 128 128 4575657222473777152 5360320512 64 128 128 4416 0 0 0 0 0 0 0 2 0 0 0 0 0 24 0 0 "
