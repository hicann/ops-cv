...
protected:
    static void SetUpTestCase() { cout << "upsample_nearest_3d_backward_test SetUp" << endl; }

    static void TearDownTestCase() { cout << "upsample_nearest_3d_backward_test TearDown" << endl; }
};
...
TEST_F(l2_upsample_nearest_3d_backward_test, case_float_normal)
{
    ...
    auto ut = OP_API_UT(aclnnUpsampleNearest3dBackward,
                        INPUT(grad_out_desc, output_size_desc, input_size_desc, scales_d, scales_h, scales_w),
                        OUTPUT(grad_input_desc));
...
TEST_F(l2_upsample_nearest_3d_backward_test, case_format_ndhwc_normal)
{
...
TEST_F(l2_upsample_nearest_3d_backward_test, case_910_normal)
{
    auto grad_out_desc = TensorDesc({2, 2, 3, 4, 5}, ACL_FLOAT, ACL_FORMAT_NCDHW);
    vector<int64_t> output_size = {3, 4, 5};
    vector<int64_t> input_size = {2, 2, 6, 8, 10};
