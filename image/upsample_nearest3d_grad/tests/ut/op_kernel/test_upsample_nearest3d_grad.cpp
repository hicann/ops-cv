...
TEST_F(upsample_nearest3d_grad_test, test_case_float_1)
{
    ...
    std::string fileName = "./upsample_nearest3d_grad_data/float32_input_upsample_nearest3d_grad.bin";
    ...
    system("cd ./upsample_nearest3d_grad_data/ && python3 compare_data.py 'float32'");
}
...
TEST_F(upsample_nearest3d_grad_test, test_case_float16)
{
    ...
    size_t gradInputByteSize = 4 * 4 * 4 * sizeof(half);
    ...
    std::string fileName = "./upsample_nearest3d_grad_data/float16_input_upsample_nearest3d_grad.bin";
    ...
    fileName = "./upsample_nearest3d_grad_data/float16_output_upsample_nearest3d_grad.bin";
    WriteFile(fileName, gradInput, gradInputByteSize);
    ...
    system("cd ./upsample_nearest3d_grad_data/ && python3 compare_data.py 'float16'");
}
TEST_F(upsample_nearest3d_grad_test, test_case_bfloat16)
{
    ...
    size_t gradInputByteSize = 4 * 4 * 4 * sizeof(bfloat16_t);
    size_t gradOutputByteSize = 16 * 16 * 16 * sizeof(bfloat16_t);
    size_t tiling_data_size = sizeof(UpsampleNearest3dGradTilingData);
    size_t workspaceSize = 32 * 1024 * 1024;
    uint32_t numBlocks = 4;
    ...
    std::string fileName = "./upsample_nearest3d_grad_data/bfloat16_input_upsample_nearest3d_grad.bin";
    ...
    fileName = "./upsample_nearest3d_grad_data/bfloat16_output_upsample_nearest3d_grad.bin";
    WriteFile(fileName, gradInput, gradInputByteSize);
    ...
    system("cd ./upsample_nearest3d_grad_data/ && python3 compare_data.py 'bfloat16'");
}