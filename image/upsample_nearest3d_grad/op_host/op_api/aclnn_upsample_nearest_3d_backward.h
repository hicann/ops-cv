...
#ifndef OP_API_INC_UPSAMPLE_NEAREST_3D_BACKWARD_H_
#define OP_API_INC_UPSAMPLE_NEAREST_3D_BACKWARD_H_
...
aclnnUpsampleNearest3dBackward(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor, aclrtStream stream);

#ifdef __cplusplus
}
#endif

#endif // OP_API_INC_UPSAMPLE_NEAREST_3D_BACKWARD_H_
