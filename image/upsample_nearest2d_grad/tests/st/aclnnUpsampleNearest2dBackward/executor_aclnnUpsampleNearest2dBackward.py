...
@register("upsample_nearest2d_backward")
class FunctionTorchUpsampleNearest2dBackwardApi(FunctionApi):
    ...
    def init_by_input_data(self, input_data: InputDataset):
        ...
        if self.device == "pyaclnn":
            ...
            if 'scale_factor' in input_data.kwargs and isinstance(input_data.kwargs['scale_factor'], tuple):
                ...
                input_data.kwargs['outputSize_int'][0] = int(input_temp.shape[2]*scale_factor_temp[0])
                input_data.kwargs['outputSize_int'][1] = int(input_temp.shape[3]*scale_factor_temp[1])
                ...
                input_data.kwargs['outputSize_int'][1] = int(input_temp.shape[3]*scale_factor_temp)
                del input_data.kwargs['scale_factor']
