                     ...
                     std::vector<Operator>& outputs, Graph& graph)
{
    ...
    std::vector<int64_t> outputShape = {1, 2, 2, 3};
    ADD_INPUT(1, input, inDtype, inputShape);
    ADD_CONST_INPUT(2, size, DT_INT32, sizeShape);
    ADD_INPUT(3, offsets, inDtype, offsetsShape);

    ADD_OUTPUT(1, glimpse, inDtype, outputShape);
