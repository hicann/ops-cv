...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><ul><li>Empty tensors are not supported. </li><li>The data type and format must be the same as those of self. </li><li>The values of out in all dimensions must be less than or equal to (2^31 – 1). </li><li>The N and C axes of the shape are the same as those of the input self.</li></ul></td>
      <td>FLOAT32, FLOAT16, BFLOAT16</td>
      <td>NCDHW, NDHWC, ND</td>
      <td>5</td>
      <td>√</td>
