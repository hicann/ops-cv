...
TEST_F(DeformableOffsetsInfershape, deformable_offsets_infer_shape_test)
{
    gert::InfershapeContextPara infershapeContextPara(
        ...
        {
            {"strides", Ops::Cv::AnyValue::CreateFrom<std::vector<int64_t>>({1, 1, 1, 1})},
            {"pads", Ops::Cv::AnyValue::CreateFrom<std::vector<int64_t>>({1, 1, 1, 1})},
            {"ksize", Ops::Cv::AnyValue::CreateFrom<std::vector<int64_t>>({3, 3})},
            {"dilations", Ops::Cv::AnyValue::CreateFrom<std::vector<int64_t>>({1, 1, 1, 1})},
            {"data_format", Ops::Cv::AnyValue::CreateFrom<std::string>("NCHW")},
            {"deformable_groups", Ops::Cv::AnyValue::CreateFrom<int64_t>(8)},
            {"modulated", Ops::Cv::AnyValue::CreateFrom<bool>(true)},
        });
