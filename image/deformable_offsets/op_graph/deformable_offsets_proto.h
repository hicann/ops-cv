 ...
 * \brief
 */
#ifndef OPS_IMAGE_DEFORMABLE_OFFSETS_PLUGIN_DEFORMABLE_OFFSETS_PROTO_H_
#define OPS_IMAGE_DEFORMABLE_OFFSETS_PLUGIN_DEFORMABLE_OFFSETS_PROTO_H_
...
#endif // OPS_IMAGE_DEFORMABLE_OFFSETS_PLUGIN_DEFORMABLE_OFFSETS_PROTO_H_
