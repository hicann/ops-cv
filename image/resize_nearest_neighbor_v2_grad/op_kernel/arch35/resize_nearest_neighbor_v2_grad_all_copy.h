...
/*!
 * \file resize_nearest_neighbor_v2_grad_all_copy.h
 * \brief resize_nearest_neighbor_v2_grad_all_copy
 */
#ifndef ResizeNearestNeighborV2Grad_ALL_COPY_H
#define ResizeNearestNeighborV2Grad_ALL_COPY_H
...
public:
    ...
    __aicore__ inline void Init(GM_ADDR grads, GM_ADDR size, GM_ADDR y, TPipe* pipe,
                                const ResizeNearestNeighborV2GradTilingData* data);
...
template <typename T_GRADS, typename T_OUT>
__aicore__ inline void ResizeNearestNeighborV2GradAllCopy<T_GRADS, T_OUT>::Init(
    GM_ADDR grads, GM_ADDR size, GM_ADDR y, TPipe* pipe, const ResizeNearestNeighborV2GradTilingData* data)
{
    ...
    pipe_->InitBuffer(dataQue_, 2, bufferSize);
}

template <typename T_GRADS, typename T_OUT>
__aicore__ inline void ResizeNearestNeighborV2GradAllCopy<T_GRADS, T_OUT>::CopyIn(int64_t gradsOffsetInGM,
                                                                                  int64_t length)
{
...
template <typename T_GRADS, typename T_OUT>
__aicore__ inline void ResizeNearestNeighborV2GradAllCopy<T_GRADS, T_OUT>::CopyOut(int64_t yOffsetInGM, int64_t length)
{
...
template <typename T_GRADS, typename T_OUT>
__aicore__ inline void ResizeNearestNeighborV2GradAllCopy<T_GRADS, T_OUT>::Process()
{
