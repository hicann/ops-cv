...
#define RESIZE_NEAREST_NEIGHBOR_V2_GRAD_TPL_KEY_DECL()                                                                 \
    ASCENDC_TPL_UINT_DECL(schId, ASCENDC_TPL_8_BW, ASCENDC_TPL_UI_LIST, TPL_SCH_ID_ALL_COPY, TPL_SCH_ID_NOT_DETERMINE, \
                          TPL_SCH_ID_DETERMINE, TPL_SCH_ID_DETERMINE_HW, TPL_SCH_ID_DETERMINE_1D,                      \
                          TPL_SCH_ID_NOT_DETERMINE_HW),                                                                \
...
#define RESIZE_NEAREST_NEIGHBOR_V2_GRAD_TPL_KEY_SEL_GROUP1()                                        \
    ASCENDC_TPL_UINT_SEL(schId, ASCENDC_TPL_UI_LIST, TPL_SCH_ID_ALL_COPY, TPL_SCH_ID_NOT_DETERMINE, \
                         TPL_SCH_ID_NOT_DETERMINE_HW),                                              \
...
#define RESIZE_NEAREST_NEIGHBOR_V2_GRAD_TPL_KEY_SEL_GROUP2()                                       \
    ASCENDC_TPL_UINT_SEL(schId, ASCENDC_TPL_UI_LIST, TPL_SCH_ID_DETERMINE_1D, TPL_SCH_ID_ALL_COPY, \
                         TPL_SCH_ID_DETERMINE),                                                    \
        ASCENDC_TPL_UINT_SEL(format, ASCENDC_TPL_UI_LIST, TPL_FORMAT_NCHW, TPL_FORMAT_NHWC),       \
