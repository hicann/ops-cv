...
@register("upsample_nearest3d")
class FunctionTorchUpsampleNearest3dApi(FunctionApi):
    def init_by_input_data(self, input_data: InputDataset):
        if self.device == "pyaclnn":
            ...
            if 'scale_factor' in input_data.kwargs and isinstance(input_data.kwargs['scale_factor'],tuple):
                ...
                input_data.kwargs['outputSize'][0] = int(input_data.kwargs['input'].shape[2]*input_data.kwargs['scale_factor'][0])
                input_data.kwargs['outputSize'][1] = int(input_data.kwargs['input'].shape[3]*input_data.kwargs['scale_factor'][1])
                input_data.kwargs['outputSize'][2] = int(input_data.kwargs['input'].shape[4]*input_data.kwargs['scale_factor'][2])
                ...
                input_data.kwargs['outputSize'][0] = int(input_data.kwargs['input'].shape[2]*input_data.kwargs['scale_factor'])
                input_data.kwargs['outputSize'][1] = int(input_data.kwargs['input'].shape[3]*input_data.kwargs['scale_factor'])
                input_data.kwargs['outputSize'][2] = int(input_data.kwargs['input'].shape[4]*input_data.kwargs['scale_factor'])
                del input_data.kwargs['scale_factor']
            elif 'size' in input_data.kwargs and isinstance(input_data.kwargs['size'],tuple):
                input_data.kwargs['outputSize'][0] = input_data.kwargs['size'][0]
                input_data.kwargs['outputSize'][1] = input_data.kwargs['size'][1]
                input_data.kwargs['outputSize'][2] = input_data.kwargs['size'][2]
            ...
            del input_data.kwargs['outputSize']
            del input_data.kwargs['format']
