...
#include "image/upsample_nearest3d/op_host/upsample_nearest3d_tiling.h"
...
TEST_F(UpsampleNearest3dTiling, upsample_nearest3d_tiling_001)
{
    ...
    std::string op_type("UpsampleNearest3d");
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeAttrs({{"output_size", ge::AnyValue::CreateFrom<std::vector<int64_t>>(output_size)},
                          {"scale_d", ge::AnyValue::CreateFrom<float>(0.0)},
                          {"scale_h", ge::AnyValue::CreateFrom<float>(0.0)},
                          {"scale_w", ge::AnyValue::CreateFrom<float>(0.0)}})
