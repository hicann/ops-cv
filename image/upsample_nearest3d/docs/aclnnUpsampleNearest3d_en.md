...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, aclnnUpsampleNearest3dGetWorkspaceSize is called to obtain the input parameters and compute the required workspace size based on the process. Then, aclnnUpsampleNearest3d is called to perform computation.
...
- **Parameters**
  ...
  <tbody>
    <tr>
      ...
      <td>Input</td>
      <td>Input tensor for upsampling. It corresponds to self in the formula.</td>
      <td><ul><li>Empty tensors are not supported. </li><li>The ND format is processed as NCDHW format by default. </li><li>The values of self in all dimensions must be less than or equal to (2^31 – 1). </li><li>The size of the C, D, H, and W dimensions of shape is greater than 0.</li></ul></td>
    ...
    <tr>
      ...
      <td>Input</td>
      <td>Spatial size of the output in the D, H, and W dimensions. It corresponds to outputSize in the formula.</td>
    ...
    <tr>
      <td>out (aclTensor*)</td>
      <td>Output</td>
      <td>Output tensor after sampling, corresponding to point p's coordinates in out in the formula.</td>
      <td><ul><li>Empty tensors are not supported. </li><li>The data type and format must be the same as those of self. </li><li>The N and C axes of the input and output shapes must be the same. </li><li>The values of out in all dimensions must be less than or equal to (2^31 – 1).</li></ul></td>
      <td>FLOAT32, FLOAT16, BFLOAT16, DOUBLE, UINT8</td>
      <td>NCDHW, NDHWC, ND</td>
      <td>5</td>
      <td>√</td>
...
- **Returns:**
  ...
  <tbody>
    ...
    <tr>
      <td>The shape of out in the D, H, or W dimension is not equal to outputSize.</td>
    </tr>
  </tbody></table>
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnUpsampleNearest3dGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
int main()
{
    ...
    aclOpExecutor* executor;
    // Call the first-phase API of aclnnUpsampleNearest3d.
    ...
    // Call the second-phase API of aclnnUpsampleNearest3d.
