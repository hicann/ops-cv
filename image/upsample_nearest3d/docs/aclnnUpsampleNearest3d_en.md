...
- Formula:
  - Core algorithm logic:
    ...
    2. For the points of the scaled destination image, calculate the nearest points of the source image, and copy the values of the latter to the former.
  - Calculation logic:
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      <td>outputSize</td>
      <td>Input</td>
      <td>Size of the output out tensor, corresponding to `outputSize` in the formula.</td>
    ...
    <tr>
      ...
      <td><ul><li>Empty tensors are not supported. </li><li>The data type and format must be the same as those of self. </li><li>The N and C of the input must be the same as those of the output. </li><li>The values of out in all dimensions must be less than or equal to (2^31 – 1).</li></ul></td>
      <td>FLOAT32, FLOAT16, BFLOAT16, DOUBLE, UINT8</td>
      <td>NCDHW, NDHWC, ND</td>
      <td>5</td>
      <td>√</td>
