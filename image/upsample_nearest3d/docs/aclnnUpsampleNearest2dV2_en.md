...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><ul><li>Empty tensors are supported. </li><li>The data type and data format are the same as those of the input parameter self. </li><li>If the data type is FLOAT32, BFLOAT16, or FLOAT16, the values of out in all dimensions are less than or equal to (2^31 – 1). </li><li>The N and C axes of shape must be the same as those of self.</li></ul></td>
      <td>FLOAT32, BFLOAT16, FLOAT16, DOUBLE, UINT8</td>
      <td>NCHW and NHWC</td>
      <td>4</td>
      <td>√</td>
