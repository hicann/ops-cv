...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, aclnnUpsampleNearest1dV2GetWorkspaceSize is called to obtain the workspace size required for computation and the executor that contains the operator computation process. Then, aclnnUpsampleNearest1dV2 is called to perform computation.
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      <td>scaleL (float)</td>
      <td>Input</td>
      <td>Multiplier of the specified spatial size, corresponding to scaleL in the formula.</td>
      <td>-</td>
      <td>-</td>
      <td>-</td>
      <td>-</td>
