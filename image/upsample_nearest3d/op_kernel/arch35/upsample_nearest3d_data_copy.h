...
/* !
 * \file upsample_nearest3d_data_copy.h
 * \brief upsample_nearest3d_data_copy.h
 */
#ifndef UPSAMPLE_NEAREST3D_DATA_COPY_H
#define UPSAMPLE_NEAREST3D_DATA_COPY_H
...
class Nearest3dDataCopy {
public:
    __aicore__ inline Nearest3dDataCopy(){};
...
template <typename T1>
__aicore__ inline void Nearest3dDataCopy<T1>::Init(GM_ADDR x, GM_ADDR y, TPipe *pipe,
    const UpsampleNearest3dRegBaseTilingData *__restrict tilingData)
{
    pipe_ = pipe;
...
template <typename T1>
__aicore__ inline void Nearest3dDataCopy<T1>::CopyIn(int64_t xOffsetInGM, int64_t length)
{
...
template <typename T1>
__aicore__ inline void Nearest3dDataCopy<T1>::CopyOut(int64_t yOffsetInGM, int64_t length)
{
...
template <typename T1>
__aicore__ inline void Nearest3dDataCopy<T1>::Process()
{
...
#endif // UPSAMPLE_NEAREST3D_DATA_COPY_H