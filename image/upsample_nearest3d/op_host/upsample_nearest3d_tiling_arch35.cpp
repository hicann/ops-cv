...
ge::graphStatus UpsampleNearest3dRegbaseTiling::GetAndCheckShapes()
{
    ...
    int32_t isUint32 = static_cast<int32_t>(
        (inputSize <= uint32Max) && (outputSize <= uint32Max) && baseTiling_.inD <= int32Max &&
        baseTiling_.inH <= int32Max && baseTiling_.inW <= int32Max && baseTiling_.outD <= int32Max &&
