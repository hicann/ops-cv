...
{
    asc_vf_call<Aipp_Kernel::SimtComputeRgb<T, DataType>>(dim3(this->blockDimX_), (__gm__ uint8_t*)x, (__gm__ T*)y,
                                                          this->tilingData_, this->gmParams_, this->blockIdx_,
                                                          this->blockNum_, this->totalNum_, this->dynamicTilingKey_);
}
