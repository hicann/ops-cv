...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><ul><li>Empty tensors are supported. </li><li>The data type must be the same as that of x.</li></ul></td>
      <td>FLOAT16, FLOAT32, BFLOAT16</td>
      <td>NCHW and ND</td>
      <td>4</td>
      <td>√</td>
...
- **Returns:**
  ...
  <tbody>
    ...
    <tr>
      <td>The value of outputSize cannot be greater than 0.</td>
    </tr>
  </tbody></table>
...
- The shape constraints of x and out are as follows:
  ...
  $$
  Height of the input shape/outputSize_H <= 50
  $$
  
  $$
  Width of the input shape/outputSize_W <= 50
  $$
