...
TEST_F(UpsampleBicubic2dAATiling, upsample_bicubic2d_aa_tiling_001)
{
    ...
    std::string op_type("UpsampleBicubic2dAA");
...
TEST_F(UpsampleBicubic2dAATiling, upsample_bicubic2d_aa_tiling_002)
{
    dlog_setlevel(0, 0, 0);
    gert::StorageShape input_shape = {{1, 1, 128, 128}, {1, 1, 128, 128}};
    gert::StorageShape out_shape = {{1, 1, 0, 0}, {1, 1, 0, 0}};
...
{
    dlog_setlevel(0, 0, 0);
    gert::StorageShape input_shape = {{1, 1, 200, 200}, {1, 1, 200, 200}};
    gert::StorageShape out_shape = {{1, 1, 36, 36}, {1, 1, 36, 36}};
    ...
    auto ws_size = reinterpret_cast<gert::ContinuousVector *>(workspace_size_holer.get());
    ASSERT_NE(param, nullptr);
    std::vector<int64_t> output_size = {36, 36};
    auto holder = gert::TilingContextFaker()
                      .SetOpType("UpsampleBicubic2dAA")
                      .NodeIoNum(1, 1)
                      .IrInstanceNum({1})
...
TEST_F(UpsampleBicubic2dAATiling, upsample_bicubic2d_aa_tiling_004)
{
    dlog_setlevel(0, 0, 0);
    gert::StorageShape input_shape = {{1, 1, 200, 200}, {1, 1, 200, 200}};
    gert::StorageShape out_shape = {{1, 1, 20, 20}, {1, 1, 20, 20}};
    ...
    auto ws_size = reinterpret_cast<gert::ContinuousVector *>(workspace_size_holer.get());
    ASSERT_NE(param, nullptr);
    std::vector<int64_t> output_size = {20, 20};
    auto holder = gert::TilingContextFaker()
                      .SetOpType("UpsampleBicubic2dAA")
                      .NodeIoNum(1, 1)
                      .IrInstanceNum({1})
