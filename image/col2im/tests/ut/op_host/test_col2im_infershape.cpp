...
protected:
    static void SetUpTestCase() { std::cout << "Col2imInfershape SetUp" << std::endl; }
    static void TearDownTestCase() { std::cout << "Col2imInfershape TearDown" << std::endl; }
};
...
TEST_F(Col2im, col2im_infershape_fp16)
{
    ...
    gert::InfershapeContextPara infershapeContextPara(
        ...
        {gert::InfershapeContextPara::OpAttr("kernel_size",
                                             Ops::Cv::AnyValue::CreateFrom<std::vector<int64_t>>({1, 5})),
