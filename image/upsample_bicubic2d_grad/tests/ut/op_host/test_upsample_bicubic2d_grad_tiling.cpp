...
protected:
    static void SetUpTestCase() { std::cout << "UpsampleBicubic2dGradTiling SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "UpsampleBicubic2dGradTiling TearDown" << std::endl; }
};
...
TEST_F(UpsampleBicubic2dGradTiling, test_tiling_float16_1)
{
    ...
    gert::TilingContextPara tilingContextPara(
        "UpsampleBicubic2dGrad", {{{{1, 2, 64, 64}, {1, 2, 64, 64}}, ge::DT_FLOAT16, ge::FORMAT_ND}},
    ...
    string expectTilingData = "171798691841 0 4539628425446424576 68719476752 2 274877906944 137438953536 68719476768 "
                              "4294967300 42949672960 8589934592 17179869200 1 10 281474976710658 412316860416 16 "
                              "34359738416 0 0 0 0 0 0 0 0 0 68719476737 68719476768 68719476800 68719476768 "
                              "137438953488 4294967312 4294967297 1 0 6597069766656 2048 4294967297 4294967297 "
                              "4294967297 0 8589934594 1 0 0 0 0 0 0 0 0 274877906945 274877906960 274877906960 "
                              "68719476752 68719476800 4294967312 4294967297 1 0 10995116277760 4096 4294967297 "
...
TEST_F(UpsampleBicubic2dGradTiling, test_tiling_float_1)
{
    ...
    gert::TilingContextPara tilingContextPara(
        "UpsampleBicubic2dGrad", {{{{1, 2, 64, 64}, {1, 2, 64, 64}}, ge::DT_FLOAT, ge::FORMAT_ND}},
        ...
        &compile_info);
    uint64_t expectTilingKey = 10000001;
    string expectTilingData = "171798691840 0 4539628425446424576 68719476752 2 274877906944 137438953536 68719476768 "
                              "4294967300 42949672960 8589934592 17179869200 1 10 140737488355330 412316860416 32 "
                              "68719476784 0 0 0 0 0 0 0 0 0 68719476737 68719476768 68719476800 68719476768 "
                              "137438953488 4294967312 4294967297 1 0 13194139533312 2048 4294967297 4294967297 "
                              "4294967297 0 8589934594 1 0 0 0 0 0 0 0 0 274877906945 274877906960 274877906960 "
                              "68719476752 68719476800 4294967312 4294967297 1 0 21990232555520 4096 4294967297 "
                              "4294967297 4294967297 0 8589934594 1 0 0 0 0 0 0 0 0 ";
...
TEST_F(UpsampleBicubic2dGradTiling, test_tiling_float_2)
{
    ...
    gert::TilingContextPara tilingContextPara(
        "UpsampleBicubic2dGrad", {{{{1, 2, 200, 200}, {1, 2, 200, 200}}, ge::DT_FLOAT, ge::FORMAT_ND}},
