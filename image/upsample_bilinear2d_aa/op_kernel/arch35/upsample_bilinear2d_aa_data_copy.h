...
/* !
 * \file upsample_bilinear2d_aa_data_copy.h
 * \brief upsample_bilinear2d_aa_data_copy.h
 */
#ifndef UPSAMPLE_BILINEAR2D_AA_DATA_COPY_H
#define UPSAMPLE_BILINEAR2D_AA_DATA_COPY_H
...
class Bilinear2dAADataCopy {
public:
    __aicore__ inline Bilinear2dAADataCopy(){};
...
template <typename T1>
__aicore__ inline void Bilinear2dAADataCopy<T1>::Init(
    GM_ADDR x, GM_ADDR y, TPipe* pipe, const UpsampleBilinear2dAARegBaseTilingData* __restrict tilingData)
{
    pipe_ = pipe;
...
template <typename T1>
__aicore__ inline void Bilinear2dAADataCopy<T1>::CopyIn(int64_t xOffsetInGM, int64_t length)
{
...
template <typename T1>
__aicore__ inline void Bilinear2dAADataCopy<T1>::CopyOut(int64_t yOffsetInGM, int64_t length)
{
...
template <typename T1>
__aicore__ inline void Bilinear2dAADataCopy<T1>::Process()
{
...
#endif // UPSAMPLE_BILINEAR2D_AA_DATA_COPY_H