...
#ifndef UPSAMPLE_BILINEAR2D_AA_INPLACE_TILING_DEF_H
#define UPSAMPLE_BILINEAR2D_AA_INPLACE_TILING_DEF_H
...
struct UpsampleBilinearAATilingData {
    int64_t slide_size;
    int64_t dataType;
    float scale_w;
    float scale_h;
...
#define GET_TILING_DATA(tilingData, tilingPointer)                                       \
    ...
    INIT_TILING_DATA(UpsampleBilinearAATilingData, tilingDataPointer, tilingPointer);    \
    ...
    (tilingData).needCoreNum_w = tilingDataPointer->needCoreNum_w;                       \
...
#endif  // UPSAMPLE_BILINEAR2D_AA_INPLACE_TILING_DEF_H