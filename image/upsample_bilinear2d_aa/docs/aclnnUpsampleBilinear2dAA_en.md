...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><ul><li>Empty tensors are not supported. </li><li>The data type, format, and shape are the same as those of input.</li></ul></td>
      <td>FLOAT32, FLOAT16, BFLOAT16</td>
      <td>NCHW and ND</td>
      <td>4</td>
      <td>√</td>
...
* **Returns:**
  ...
  <tbody>
    ...
    <tr>
      <td>The data formats of input and out are inconsistent.</td>
    </tr>
    <tr>
...
- <term>Atlas A3 training products/Atlas A3 inference products</term> and <term>Atlas A2 training products/Atlas A2 inference products</term>:
  ...
  $$
  Height of the input shape H/outputSize_H <= 50
  $$
  
  $$
  Width of the input shape W/outputSize_W <= 50
  $$
...
int main()
{
    ...
    aclOpExecutor *executor;
    // Call the first-phase API of aclnnUpsampleBilinear2dAA.
    ...
    // Call the second-phase API of aclnnUpsampleBilinear2dAA.
