...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><ul><li>Empty tensors are not supported. </li><li>The data type, format, and shape are the same as those of the input parameter gradOut.</li></ul></td>
      <td>FLOAT32, FLOAT16, BFLOAT16</td>
      <td>NCHW and NHWC</td>
      <td>4</td>
      <td>√</td>
...
- **Returns:**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>The data type and format of gradOut and out are not supported.</td>
    </tr>
    <tr>
      <td>The data type or shape of gradOut is inconsistent with that of out.</td>
    </tr>
    <tr>
