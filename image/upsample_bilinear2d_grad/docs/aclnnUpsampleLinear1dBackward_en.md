...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Input</td>
      <td>A parameter of the Boolean type, corresponding to alignCorners in the formula.</td>
      <td><ul><li>If True, the input and output tensors are aligned by the center points of their corner pixels, preserving the values at the corner pixels.</li><li>If False, the input and output tensors are aligned by the corner points of their corner pixels, and the interpolation uses edge value padding for out-of-boundary values.</li></ul></td>
      <td>-</td>
      <td>-</td>
      <td>-</td>
      <td>-</td>
    ...
    <tr>
      ...
      <td>The value cannot be greater than 500.</td>
      <td>-</td>
      <td>-</td>
      <td>-</td>
      <td>-</td>
    ...
    <tr>
      ...
      <td><ul><li>Empty tensors are not supported.</li><li>The output shape must be 3D. The data type and format are the same as those of the input parameter gradOut.</li></ul></td>
      <td>FLOAT32, FLOAT16, BFLOAT16</td>
      <td>NCL</td>
      <td>3</td>
      <td>√</td>
...
- **Returns:**
  ...
  <tbody>
    ...
    <tr><td>The value of scales does not meet the constraints.</td>
    </tr>
  </tbody></table>
...
- The shape constraints of gradOut and out are as follows:
  ...
  - <term>Atlas A2 training products/Atlas A2 inference products</term> and <term>Atlas A3 training products/Atlas A3 inference products</term>: The upscaling factor for input data must be less than or equal to 500.
  
  $$
  outputSize[0] / Length of the output shape L <= 500
  $$
