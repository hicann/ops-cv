...
protected:
    static void SetUpTestCase() { std::cout << "l2_upsamplelinear1d_backward_test SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "l2_upsamplelinear1d_backward_test TearDown" << std::endl; }
};
