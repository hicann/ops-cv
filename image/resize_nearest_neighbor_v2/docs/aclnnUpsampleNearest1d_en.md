...
- **Parameters:**
  ...
  <tbody>
    <tr>
      ...
      <td><ul><li>Empty tensors are not supported. </li><li>The input shape must be 3D. If the data type is DOUBLE or UINT8, the `L` dimension of the input shape must be less than 2^24.</li></ul></td>
    ...
    <tr>
      ...
      <td><ul><li>Empty tensors are not supported.</li><li>The data type must be the same as that of the input parameter `self`.</li></ul></td>
      <td>FLOAT32, FLOAT16, BFLOAT16, DOUBLE, UINT8</td>
      <td>NCL</td>
      <td>3</td>
      <td>√</td>
...
- **Parameters:**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnUpsampleNearest1dGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnUpsampleNearest1d.
  ...
  // Call the second-phase API of aclnnUpsampleNearest1d.
