...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><ul><li>Empty tensors are not supported. </li><li> The data type and data format must be the same as those of the input parameter self. </li><li>The N and C axes of the shape must be the same as those of the input parameter self.</li></ul></td>
      <td>FLOAT32, BFLOAT16, FLOAT16, DOUBLE, UINT8</td>
      <td>NCHW and NHWC</td>
      <td>4</td>
      <td>√</td>
