...
#include "../../op_graph/points_in_polygons_proto.h"
                     ...
                     std::vector<Operator>& outputs, Graph& graph)
{
    Status ret = SUCCESS;
    // 自定义代码：添加单算子定义到图中
    auto add1 = op::PointsInPolygons("add1");
    std::vector<int64_t> pointsShape = {4, 2};
    std::vector<int64_t> polygonsShape = {8, 2};
    std::vector<int64_t> outputShape = {4, 2};
    ADD_INPUT(1, points, inDtype, pointsShape);
    ADD_INPUT(2, polygons, inDtype, polygonsShape);

    ADD_OUTPUT(1, output, inDtype, outputShape);
