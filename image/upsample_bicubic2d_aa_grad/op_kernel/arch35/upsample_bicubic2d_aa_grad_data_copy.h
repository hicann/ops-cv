...
/* !
 * \file upsample_bicubic2d_aa_grad_data_copy.h
 * \brief upsample_bicubic2d_aa_grad_data_copy.h
 */
#ifndef UPSAMPLE_BICUBIC2D_AA_GRAD_DATA_COPY_H
#define UPSAMPLE_BICUBIC2D_AA_GRAD_DATA_COPY_H
...
class Bicubic2dAAGradDataCopy {
public:
    __aicore__ inline Bicubic2dAAGradDataCopy(){};
...
template <typename T1>
__aicore__ inline void Bicubic2dAAGradDataCopy<T1>::Init(
    GM_ADDR x, GM_ADDR y, TPipe* pipe, const UpsampleBicubic2dAAGradRegBaseTilingData* __restrict tilingData)
{
    pipe_ = pipe;
...
template <typename T1>
__aicore__ inline void Bicubic2dAAGradDataCopy<T1>::CopyIn(int64_t xOffsetInGM, int64_t length)
{
...
template <typename T1>
__aicore__ inline void Bicubic2dAAGradDataCopy<T1>::CopyOut(int64_t yOffsetInGM, int64_t length)
{
...
template <typename T1>
__aicore__ inline void Bicubic2dAAGradDataCopy<T1>::Process()
{
...
#endif // UPSAMPLE_BICUBIC2D_AA_GRAD_DATA_COPY_H