...
class l2_upsample_bicubic2d_aa_grad_test : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "l2_upsample_bicubic2d_aa_backward_test SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "l2_upsample_bicubic2d_aa_backward_test TearDown" << std::endl; }
};
...
// inputsize nullptr
TEST_F(l2_upsample_bicubic2d_aa_grad_test, l2_upsample_bicubic2d_aa_grad_test_outputsize_nullptr)
{
    auto gradOutput_desc = TensorDesc({1, 1, 5, 5}, ACL_FLOAT, ACL_FORMAT_NCHW);
    auto out_desc = TensorDesc({1, 1, 3, 3}, ACL_FLOAT, ACL_FORMAT_NCHW);
    auto output_size_desc = IntArrayDesc(vector<int64_t>{5, 5});
...
// dtype float16
TEST_F(l2_upsample_bicubic2d_aa_grad_test, l2_upsample_bicubic2d_aa_grad_test_dtype_float16)
{
...
// dtype float32
TEST_F(l2_upsample_bicubic2d_aa_grad_test, l2_upsample_bicubic2d_aa_grad_test_dtype_float32)
{
    auto gradOutput_desc = TensorDesc({1, 1, 5, 5}, ACL_FLOAT, ACL_FORMAT_NCHW);
    auto out_desc = TensorDesc({1, 1, 3, 3}, ACL_FLOAT, ACL_FORMAT_NCHW);
    auto output_size_desc = IntArrayDesc(vector<int64_t>{5, 5});
...
// gradOutput empty N
TEST_F(l2_upsample_bicubic2d_aa_grad_test, l2_upsample_bicubic2d_aa_grad_test_gradOutput_empty_n)
{
...
// gradOutput empty C
TEST_F(l2_upsample_bicubic2d_aa_grad_test, l2_upsample_bicubic2d_aa_grad_test_gradOutput_empty_c)
{
...
// gradOutput empty H
TEST_F(l2_upsample_bicubic2d_aa_grad_test, l2_upsample_bicubic2d_aa_grad_test_gradOutput_empty_h)
{
...
// inputsize value 0
TEST_F(l2_upsample_bicubic2d_aa_grad_test, l2_upsample_bicubic2d_aa_grad_test_inputsize_value_0)
{
    auto gradOutput_desc = TensorDesc({1, 1, 5, 5}, ACL_FLOAT, ACL_FORMAT_NCHW);
    auto out_desc = TensorDesc({1, 1, 3, 3}, ACL_FLOAT, ACL_FORMAT_NCHW);
    auto output_size_desc = IntArrayDesc(vector<int64_t>{5, 5});
...
// inputsize size 5
TEST_F(l2_upsample_bicubic2d_aa_grad_test, l2_upsample_bicubic2d_aa_grad_test_inputsize_size_5)
{
    auto gradOutput_desc = TensorDesc({1, 1, 5, 5}, ACL_FLOAT, ACL_FORMAT_NCHW);
    auto out_desc = TensorDesc({1, 1, 3, 3}, ACL_FLOAT, ACL_FORMAT_NCHW);
    auto output_size_desc = IntArrayDesc(vector<int64_t>{5, 5});
...
// gradOutput shape 3d
TEST_F(l2_upsample_bicubic2d_aa_grad_test, l2_upsample_bicubic2d_aa_grad_test_shape_3d)
{
...
TEST_F(l2_upsample_bicubic2d_aa_grad_test, l2_upsample_bicubic2d_aa_grad_test_dtype_different)
{
    auto gradOutput_desc = TensorDesc({1, 1, 5, 5}, ACL_FLOAT, ACL_FORMAT_NCHW);
    auto out_desc = TensorDesc({1, 1, 3, 3}, ACL_FLOAT16, ACL_FORMAT_NCHW);
    auto output_size_desc = IntArrayDesc(vector<int64_t>{5, 5});
