...
#include "image/upsample_bicubic2d_aa_grad/op_host/upsample_bicubic2d_aa_grad_tiling.h"
...
TEST_F(UpsampleBicubic2dAAGradTiling, upsample_bicubic2d_aa_Grad_tiling_001)
{
    ...
    std::string op_type("UpsampleBicubic2dAAGrad");
    ...
    auto holder = gert::TilingContextFaker()
                      .SetOpType("UpsampleBicubic2dAAGrad")
                      .NodeIoNum(1, 1)
                      .IrInstanceNum({1})
