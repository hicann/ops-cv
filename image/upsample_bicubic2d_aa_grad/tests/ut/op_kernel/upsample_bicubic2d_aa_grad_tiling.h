...
#ifndef UPSAMPLE_BICUBIC2D_AA_GRAD_TILING_DEF_H
#define UPSAMPLE_BICUBIC2D_AA_GRAD_TILING_DEF_H
...
struct UpsampleBicubicAAGradTilingData {
    int64_t slide_size;
    uint8_t dataType;
    float scale_w;
    float scale_h;
...
#define GET_TILING_DATA(tilingData, tilingPointer)                                                       \
    ...
    INIT_TILING_DATA(UpsampleBicubicAAGradTilingData, tilingDataPointer, tilingPointer);                 \
...
#endif  // UPSAMPLE_BILINEAR2D_AA_BACKWARD_TILING_DEF_H