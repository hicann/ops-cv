...
/* !
 * \file resize_linear_grad_out1.h
 * \brief resize_linear_grad_out1
 */

#ifndef CANN_RESIZE_LINEAR_GRAD_OUT1_H
#define CANN_RESIZE_LINEAR_GRAD_OUT1_H
...
// L of grads shape == 1 and align_corners = True
template <typename T1, typename T2>
class ResizeLinearGradOut1 {
public:
...
template <typename T1, typename T2>
__aicore__ inline void ResizeLinearGradOut1<T1, T2>::Process()
{
...
#endif // CANN_RESIZE_LINEAR_GRAD_OUT1_H
