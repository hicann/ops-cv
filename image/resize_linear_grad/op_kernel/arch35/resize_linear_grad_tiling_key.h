...
#define RESIZE_LINEAR_GRAD_TPL_SCH_MODE_5 \
    5 // POINT COPY只做了非确定性，确定性没做，确定性的点copy和linear_grad走一样逻辑
...
#define RESIZE_LINEAR_GRAD_TPL_KEY_DECL()                                                                  \
    ASCENDC_TPL_UINT_DECL(schId, ASCENDC_TPL_8_BW, ASCENDC_TPL_UI_LIST, RESIZE_LINEAR_GRAD_TPL_SCH_MODE_0, \
                          RESIZE_LINEAR_GRAD_TPL_SCH_MODE_1, RESIZE_LINEAR_GRAD_TPL_SCH_MODE_2,            \
                          RESIZE_LINEAR_GRAD_TPL_SCH_MODE_3, RESIZE_LINEAR_GRAD_TPL_SCH_MODE_4,            \
