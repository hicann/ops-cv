...
protected:
    static void SetUpTestCase() { std::cout << "ResizeLinearGradInfershapeTest SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "ResizeLinearGradInfershapeTest TearDown" << std::endl; }
};
