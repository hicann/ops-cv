...
protected:
    static void SetUpTestCase() { std::cout << "UpsampleBilinear2dAABackwardTiling SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "UpsampleBilinear2dAABackwardTiling TearDown" << std::endl; }
};
...
TEST_F(UpsampleBilinear2dAABackwardTiling, upsample_bilinear2d_aa_backward_tiling_002)
{
    ...
    string expectTilingData = "341 48 16 1365 48 16 1 1 256 256 128 128 12 12 4611686018427387904 4539628425463201792 "
