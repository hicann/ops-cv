...
#include "image/upsample_bilinear2d_aa_backward/op_host/upsample_bilinear2d_aa_backward_tiling.h"
...
TEST_F(UpsampleBilinear2dAABackwardTiling, upsample_bilinear2d_aa_backward_tiling_001)
{
    ...
    std::string op_type("UpsampleBilinear2dAABackward");
    ...
    auto holder = gert::TilingContextFaker()
                      .SetOpType("UpsampleBilinear2dAABackward")
                      .NodeIoNum(1, 1)
                      .IrInstanceNum({1})
