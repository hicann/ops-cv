...
/* !
 * \file upsample_bilinear2d_aa_backward_data_copy.h
 * \brief
 */
#ifndef UPSAMPLE_BILINEAR2D_AA_BACKWARD_DATA_COPY_H
#define UPSAMPLE_BILINEAR2D_AA_BACKWARD_DATA_COPY_H
...
class Bilinear2dAABackwardDataCopy {
public:
...
template <typename T1>
__aicore__ inline void Bilinear2dAABackwardDataCopy<T1>::CopyIn(int64_t xOffsetInGM, int64_t length)
{
...
template <typename T1>
__aicore__ inline void Bilinear2dAABackwardDataCopy<T1>::CopyOut(int64_t yOffsetInGM, int64_t length)
{
...
#endif // UPSAMPLE_BILINEAR2D_AA_BACKWARD_DATA_COPY_H
