...
/*!
 * \file image_warp_offsets_aicpu_def.cpp
 * \brief image_warp_offsets def
 */
...
namespace ops {
class IMGWarpOffsets : public OpDef {
public:
    explicit IMGWarpOffsets(const char* name) : OpDef(name)
    {
        ApplyCvAicpuDefaultCfg(*this);
        this->Input("images").DataType({ge::DT_UINT8, ge::DT_FLOAT16, ge::DT_FLOAT});
